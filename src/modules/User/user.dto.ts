import { z } from "zod";
import { changeRole, freezeAccount, hardDelete, logout, restoreAccount, shareProfile, updateBasicInfo, updateEmail, updatePassword } from "./user.validation";
...
export type IChangeRoleParamsDto = z.infer<typeof changeRole.params>;
export type IChangeRoleBodyDto = z.infer<typeof changeRole.body>;
