...
const post_resolver_gql_1 = require("./post.resolver.gql");
const graphQlArgs = __importStar(require("./post.args"));
const graphQLTypes = __importStar(require("./post.types.gql"));
class PostGqlSchema {
    postResolver = new post_resolver_gql_1.PostResolver();
    constructor() { }
    ;
    registerQuery = () => {
        return {
