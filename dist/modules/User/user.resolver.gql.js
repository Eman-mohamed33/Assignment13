...
class UserResolver {
    ...
    welcome = async (parent, args, context) => {
        await (0, validation_middleware_1.graphQlValidation)(validators.welcome, args);
        await (0, authentication_middleware_1.graphQlAuthorization)(user_authorization_1.endPoint.welcome, context.user.role);
